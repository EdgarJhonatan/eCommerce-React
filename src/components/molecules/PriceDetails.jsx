    ...
    <div className="flex items-center justify-between mb-4">
      <div>
        ...
        <p className="text-gray-600">
          en <span className="text-green-500 font-semibold">{getInstallments(price, 12)}</span>
        </p>
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="text-sm">
          <p className="font-semibold text-gray-600">Protección al Comprador de 75 días</p>
